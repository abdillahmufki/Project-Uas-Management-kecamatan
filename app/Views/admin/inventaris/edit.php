...
<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3 " novalidate="" method="POST" action="<?= base_url('admin/inventaris/handleEdit') ?>">
            <?php if ($inventaris) : ?>
            ...
            <div class="col-lg-6">
                <h5 class="font-weight-bold">Jumlah Barang/Bangunan Awal Tahun</h5>
            </div>
            <div class="col-lg-6">
                <h5 class="font-weight-bold">Jumlah Barang/Bangunan Akhir Tahun</h5>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <h5 class="font-weight-bold">Jumlah Barang/Bangunan berdasarkan sumber</h5>
            </div>
            <div class="col-lg-6">
                <h5 class="font-weight-bold">Jumlah Dihapus</h5>
            </div>
            <div class="col-lg-6">

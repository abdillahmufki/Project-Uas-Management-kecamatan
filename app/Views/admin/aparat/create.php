            ...
            <form class="row g-3 " novalidate="" method="post" action="<?= base_url('aparat/store')?>">
              ...
              <?php endif; ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control <?= $validation->hasError('kecamatanId') ? 'is-invalid' : ''?>" id="kecamatanId" name="kecamatanId" value="<?= $aparat["kecamatan_id"] ?? old('kecamatanId')?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control <?= $validation->hasError('kelurahanId') ? 'is-invalid' : ''?>" id="kelurahanId" name="kelurahanId" value="<?= $aparat["kelurahan_id"] ?? old('kelurahanId')?>" required>
                    <div class="invalid-feedback">
